...
The PRISM formatted ClinVar data used for the data generation is hosted at the
Electronic Research Data Archive at University of Copenhagen (ERDA) at
https://sid.erda.dk/cgi-sid/ls.py?share_id=c3rDfqR8nn. Download the 'prism' directory
and specify the path to the directory in the code at the arrow mark.
...
class DataProcessor:
    ...
    def process_data(self) -> list:
        ...
        """
        prismDir = " " # <-- PATH TO PRISM DIRECTORY
        db_columns = [
            "IDRFragments",
            "UniProt_ID",
            "N",
...
def main():
    ...
    data_processor.load_dataframe(" ") # <-- PATH TO 'IDRome_DB.csv' FILE
    processed_data = data_processor.process_data()
    data_processor.export_data(data=processed_data, filename="./idr_fragments_clinvar_info.csv")
